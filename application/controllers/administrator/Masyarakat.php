<?php class Masyarakat extends CI_Controller{
...
public function informasi(){
    ...
    public function input(){
        ...
        $this->load->view('administrator/input_stunting2',$data);
        $this->load->view('template_administrator/footer');
    }
    ...
    public function input_aksi(){$this->_rules();
        ...
        if ($this->form_validation->run()==FALSE){
            ...
            redirect('administrator/masyarakat/input');
            ...
            redirect('administrator/masyarakat');
        }
    }
...
public function update($id){
    ...
    $this->load->view('template_administrator/header');
    $this->load->view('template_administrator/sidebar',$data);
    $this->load->view('administrator/update_stunting2',$data);
    $this->load->view('template_administrator/footer');
    }
...
public function update_aksi()
    ...
    $data['stunting'] = $this->stunting_model->join2table($id_user)->result();
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar',$data);
        $this->load->view('administrator/bbu1',$data);
        $this->load->view('template_administrator/footer');
    ...
    $data['stunting'] = $this->stunting_model->join2table($id_user)->result();
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar',$data);
        $this->load->view('administrator/pbu1',$data);
        $this->load->view('template_administrator/footer');
    ...
    $data['stunting'] = $this->stunting_model->join2table($id_user)->result();
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar',$data);
        $this->load->view('administrator/imtu1',$data);
        $this->load->view('template_administrator/footer');
    ...
    // menghubungkan controller dengan model yang kita buat
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar',$data);
        $this->load->view('administrator/bbpb1',$data);
        $this->load->view('template_administrator/footer');
