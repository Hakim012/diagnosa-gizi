        ...
        <aside class="menu-sidebar2">
            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                ...
                <nav class="navbar-sidebar2">
                    <!-- <center> 
                        <li>
                        <p href="#">Jln. Lembaga, No. 01 Senggoro - Bengkalis - Riau, 28751</p>
                        <li>
                        <p href="#">Telp.  0822-8441-9009</p>
                        <li>
        ...
        <div class="page-container2">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap2">
                            <!-- <marquee><h3 style="color: rgb(252, 250, 250);text-align: left;">SELAMAT DATANG DI APLIKASI PENDETEKSI STUNTING</h3></marquee> -->
                            <!-- <h3 style="color: rgb(252, 250, 250);text-align: left;">APLIKASI PENDETEKSI STUNTING</h3> -->
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Pendeteksi Stunting</li>
                                        </ul>
                                    </div>
            ...
            <section class="statistic">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="card">
                            <div class="card-header text-primary"><b>Form Pendeteksi Stunting</b></div>
                            <div class="card-body card-block">
                                <form action="<?php echo base_url('auth/input_aksi')?>" method="post" class="">
                                <?php echo $this->session->flashdata('pesan')?>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="umur" name="umur" placeholder="Umur Anak ..." class="form-control">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="gejala" name="gejala" placeholder="Gejala ..." class="form-control">
                                        </div>
                                        <?php echo form_error('gejala','<div class="text-danger small" ml-3>')?>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <textarea name="kepentingan" id="textarea-input" rows="3" placeholder="Keterangan ..." class="form-control"></textarea>
