	...
	<div class="page-wrapper">
		...
		<aside class="menu-sidebar2">
			<div class="logo" style="background: #00682c;">
				<a href="#">
					<h1 style="color: rgb(252, 250, 250);">Klasifikasi</h1>
				</a>
			</div>
			<div class="menu-sidebar2__content js-scrollbar1">
				<div class="account2">
					...
					<center>
						<h4 class="name">Klasifikasi Gizi</h4>
					</center>
				</div>
								...
								<form action="<?php echo base_url('administrator/auth/proses_login') ?>" method="post" class="">
									...
									<div class="form-group">
										<div class="input-group">
											...
											<input type="text" id="nama" name="username" placeholder="Username ..." class="form-control">
										</div>
			...
			<section>
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="copyright">
								<p>Copyright © 2023 <a href="#">Klasifikasi Gizi</a>. All rights reserved.</p>
							</div>
						</div>
					</div>
				</div>
