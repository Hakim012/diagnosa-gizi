...
<div class="container">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Data Batita</h6>
		</div>
			...
			<div class="row">
				...
				<div class="col">
					<div class="float-right">
						<?php echo anchor('administrator/klasifikasi/input_batita', '<button class="au-btn au-btn-icon bg-primary au-btn--small float-right"><i class="fas fa-plus"></i> Tambah Data Batita</button>') ?>
					</div>
				</div>
			</div>
			<br>
								...
								<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												Apakah Anda Yakin akan Menghapus Data Batita <?php echo $jrs->nama ?> ?
											</div>
											<div class="modal-footer">
												<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
												<?php echo anchor('administrator/klasifikasi/hapus_batita/' . $jrs->id, '<button type="button" class="btn btn-primary">Hapus</button>') ?>
											</div>
										</div>
									</div>
								</div>
