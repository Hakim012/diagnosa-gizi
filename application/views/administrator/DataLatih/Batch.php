<div class="container">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">INPUT BATCH DATA LATIH</h6>
	...
	<div class="card-body">
		...
		<form method="post" action="<?php echo base_url('administrator/klasifikasi/save_batch') ?>" enctype="multipart/form-data">
			<div class="col-md-8">
				<!--file input example -->
