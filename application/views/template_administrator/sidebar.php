		...
		<aside class="menu-sidebar2">
			<div class="logo" style="background: #00682c;">
				<a href="#">
					<h3 style="color: rgb(252, 250, 250);">Klasifikasi</h3>
				</a>
			</div>
				...
				<div class="menu-sidebar2__content js-scrollbar2">
					...
					<nav class="navbar-sidebar2">
						<ul class="list-unstyled navbar__list">
							...
							<li>
								<a href="<?php echo base_url('administrator/klasifikasi/informasi') ?>">
									<i class="fas fa-info"></i> Informasi klasifikasi</a>
							</li>
							<li>
								<a href="<?php echo base_url('administrator/tamu') ?>">
									<i class="fas fa-group"></i>Data klasifikasi</a>
							</li>
							<li class="has-sub">
								<a class="js-arrow" href="#">
